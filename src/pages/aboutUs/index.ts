...
export const data = `<p>大家好，欢迎来到茶文化研究网站！这个网站是由北京师范大学附属实验中学 2025 届学生为宣传中国茶文化成立的一个网站。</p>
<img src="${about2}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25);  border-radius:12px;"/>
...
<img src="${addus2}" align="left" width="15%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
