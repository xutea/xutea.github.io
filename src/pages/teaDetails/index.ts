import white1 from "/public/details/white-tea1.jpg";
import white2 from "/public/details/white-tea2.jpg";
import white3 from "/public/details/white-tea3.png";
import white4 from "/public/details/white-tea4.png";
import white5 from "/public/details/white-tea5.png";
import green1 from "/public/details/green-tea1.jpg";
import green2 from "/public/details/green-tea2.jpg";
import green3 from "/public/details/green-tea3.jpg";
import green4 from "/public/details/green-tea4.png";
import green5 from "/public/details/green-tea5.png";

import red1 from "/public/details/red-tea1.jpg";
import red2 from "/public/details/red-tea2.jpg";
import red3 from "/public/details/red-tea3.jpg";
import red4 from "/public/details/red-tea4.jpg";
import red5 from "/public/details/red-tea5.jpg";
import nong1 from "/public/details/nong1.jpg";
import nong2 from "/public/details/nong2.png";
import huodong1 from "/public/details/huodong1.jpg";
import huodong2 from "/public/details/huodong2.jpg";
import huodong3 from "/public/details/huodong3.jpg";
import health from "/public/details/health.jpg";
import health2 from "/public/details/health2.png";
import health3 from "/public/details/health3.png";
import health4 from "/public/details/health4.png";
import black1 from "/public/details/black-tea1.jpg";
import black2 from "/public/details/black-tea2.jpg";
import black3 from "/public/details/black-tea3.jpg";
import black4 from "/public/details/black-tea4.jpg";
import black5 from "/public/details/black-tea5.jpg";
import black6 from "/public/details/black-tea6.jpg";
import black7 from "/public/details/black-tea7.jpg";
import qing1 from "/public/details/qing-tea1.jpg";
import qing2 from "/public/details/qing-tea2.jpg";
import qing3 from "/public/details/qing-tea3.png";
import qing4 from "/public/details/qing-tea4.png";
...
export const dataList = {
  '白茶': {
    ...
    text: `<p>中国茶类的划分有多种方法，根据制作方法和茶多酚氧化（发酵）程度的不同，可分为六大类(茶叶中发酵程度的轻重不是绝对的，当有小幅度的误差)：绿茶（不发酵）、白茶（轻微发酵）、黄茶（轻发酵）、青茶（乌龙茶、半发酵）、黑茶（后发酵）、红茶（全发酵）。外观由绿向黄绿、黄、青褐、黑色渐变，茶汤也由绿向黄绿、黄、青褐、红褐色渐变。今天我们首先来介绍白茶。</p>
      <p>一、白茶的文献记载</p>
      <p><img src="${white4}" align="right" width="40%" hspace="15" vspace="5" />白茶的名字最早出现在唐朝陆羽的《茶经》七之事中，其记载：“永嘉县东三百里有白茶山。”陈橼教授在《茶叶通史》中指出：“永嘉东三百里是海，是南三百里之误，南三百里是福建福鼎（唐为长溪县轄区），系白茶原产地。”可见唐代长溪县，也就是现在福建福鼎已培育出“白茶”品种，因成品茶多为芽头，满披白毫，如银似雪而得名。</p>
      <p>
      ...
      <p>三、白茶的产地和分类</p>
      <p>
      <img src="${white1}" align="left" width="40%" hspace="15" vspace="5" >
      ...
      <p  style="text-align:center"> <img src="${white2}"  width="50%"></p>
  ...
  '绿茶': {
    ...
    text: `<p>一、绿茶的历史</p>
      ...
      <p  style="text-align:center"> <img src="${green1}" width="40%"></p>
      <p>宋徽宗在《大观茶论》中对採摘、蒸压、制作、烘焙等制作过程又进行了更加细致的描述。</p>
      <p  style="text-align:center"><img src="${green2}" width="40%"></p>
      ...
      <p  style="text-align:center"><img src="${green3}" width="40%"></p>
      <p>三、绿茶的加工工艺</p>
      <p>绿茶属不发酵茶类，也就是说茶树的鲜叶不经过发酵工序，直接杀青，成品干茶成绿色，总体品质特徵是清汤绿叶。</p>
      <p>尽管不同的绿茶加工方法有很多差异，但是基本的加工工序是一致的，即採摘、杀青、揉捻、干燥。</p>
      <p>1.第一步，鲜叶採摘</p>
      <p><img src="${green4}"  align="right" width="40%" hspace="15" vspace="5"/>绿茶的採摘突出一个早和嫩。</p>
      ...
      <p>四、绿茶的功效和药用价值</p>
      <p><img src="${green5}" align="left" width="30%" hspace="15" vspace="5"/>绿茶性质寒凉，伤胃、泻火，如果喝新的绿茶，火在上，寒在下，喝了会胃不舒服，且容易上火。虚寒体质的人不建议喝绿茶，如果想喝的话，可以适当的放一点盛放一年以上的老绿茶。</p>
      <p>绿茶要考虑地域和人体差异。</p>
  ...
  '红茶': {
    ...
    text: `
      ...
      <p><img align="right" width="40%" hspace="15" vspace="5" src="${red1}"/>待到第二天军队离去，茶农才返回茶场，而前一天采好的茶青因无法得到及时处理，已经产生红变，为了挽回损失，茶农迅速将这些茶叶搓揉，并用当地易燃的马尾松木加温烘干。</p >
      <p>
      ...
      <p><img src="${red2}"  align="left" width="40%" hspace="15" vspace="5"/>第一步，鲜叶采摘。</p >
      <p>
      ...
      <h3>三、红茶的分类</h3>
      <p>1.小种红茶</p >
      <p><img src="${red3}" align="right" width="40%" hspace="15" vspace="5"/>小种红茶是福建特有的一种条形红茶，分正山小种和外山小种，它们之间的区别在于产地、制作工艺和风味特点。</p >
      ...
      <p>3.红碎茶</p >
      <p><img src="${red4}"  align="left" width="40%" hspace="15" vspace="5">红碎茶的茶青在初制时经过充分的揉切，细胞破坏率高，有利于多酚类酶促氧化，形成了香气高锐持久、滋味浓强鲜爽。加糖或牛奶后仍有较强茶味的品质特徵。</p>
      ...
      <p  style="text-align:center"><img src="${red5}" width="40%"></p>
      <h3>五、红茶的储存</h3>
  ...
  '黑茶': {
    ...
    <h2><img src="${black3}" align="right" width="30%" hspace="15" vspace="5"/>一、黑茶的起源</h2>
    ...
    <p style="text-align:center"><img  src="${black1}" width="45%"><img src="${black2}" width="40%" style="margin-left:20px;"></p>
    ...
    <h3>3.广西六堡茶
    <img src="${black4}" align="right" width="30%" hspace="15" vspace="5"/>
    </h3>
    ...
    <p><img src="${black5}" align="left" width="30%" hspace="15" vspace="5"/>六堡茶因产于广西梧州六堡镇而得名，选用苍梧县群体种、广西大中叶种及其分离、选育的品种。以茶树的鲜叶为原料，按特定的工艺进行加工，是具有独特品质特征的黑茶。六堡茶一般以一芽两、三叶，或者一芽三、四叶为原料，产品有散装或者篓装两种形式。</p >
    ...
    <p style="text-align:center"><img src="${black6}" width="50%" /></p>
    <h3>5.云南普洱茶</h3>
    ...
    <p style="text-align:center"><img src="${black7}" width="50%"/></p>
    <p>参考文献：</p>
  ...
  '青茶': {
    ...
    text: `<p>青茶俗称乌龙茶，属半发酵茶，是我国六大基本茶类中独具特色的一个茶类。</p>
      ...
      <p style="text-align:center"><img src="${qing3}"  width="50%" hspace="15" vspace="5" /></p>
      <h2>二、闽南乌龙（安溪铁观音）</h2>
    ...
    <h2>三、台湾乌龙</h2>
    <p><img src="${qing1}" align="right" width="35%" hspace="15" vspace="5" />台湾乌龙是清朝初年由福建武夷山传入台湾，制法仿效武夷岩茶。</p>
    ...
    <p><img src="${qing2}" align="left" width="40%" hspace="15" vspace="5" />潮安乌龙茶因主要产于凤凰乡，一般以水仙品种结合地名而称为“凤凰水仙”。凤凰单丛是从“凤凰水仙”的茶树品种中选育出来的优异单株，品质优于凤凰水仙。</p>
    ...
    <p><img src="${qing4}" align="left" width="40%" hspace="15" vspace="5" />武夷山是福建省第一名山，有典型的丹霞地貌，也是三教名山。武夷山的自然保护区是地球同纬度地区保护最好的、物种最丰富的生态系统。</p>
  ...
  "茶与神农（理工版）": {
    ...
    text: `
      ...
      <p><img src="${nong1}" align="right" width="40%" hspace="15" vspace="5"/>《史记·补三皇本纪》说，“神农氏作蜡祭，以赭鞭鞭草木，尝百草，始有医药。”《淮南子·修务训》说，“神农尝百草之滋味，一日而遇七十毒。”晋干宝《搜神记》说，“神农以赭鞭鞭百草，尽知其平毒寒温之性，臭味所主，以播百谷。”《述异记》说，“太原神釜冈中，有神农尝药之鼎存焉。咸阳山中，有神农鞭药处。”</p>
  ...
  "茶与神农（文史哲版）": {
    ...
    <h3><img src="${nong1}" align="right" width="30%" hspace="15" vspace="5"/>三、神农是谁</h3>
    ...
    <p style="text-align:center"><img src="${nong2}" width="50%"/></p>
    <p>参考文献：</p>
    <ol>
      <li>
  ...
  "茗香飘万里 何须恋糖精": {
    ...
    <h3><img src="${huodong1}"  align="right" width="40%" hspace="15" vspace="5"/>一、活动背景</h3>
    ...
    <h3>二、活动目的</h3>
    <p><img src="${huodong2}" align="left" width="40%" hspace="15" vspace="5"/>为引导同学们建立健康的饮水习惯，同时传承中国茶文化，SDSZ茶文化研究社的同学们共同倡议开展“茗香飘万里，何须恋糖精”的活动。</p>
    <h3>三、活动过程</h3>
    ...
    <p style="text-align:center"><img src="${huodong3}" width="30%" /></p>`,
  },
  '茶与养生保健': {
    text: `
      <p style="text-align:center"><strong>李卓远</strong></p>
      <p style="text-align:center"><strong>2023年12月7日</strong></p>
      <p><img src="${health2}" align="right" width="30%" hspace="15" vspace="5" />昨天线下活动开展后，有同学问我，喝茶到底对身体有什么好处？这毕竟是个严肃的问题，回答的内容必须要有依据。于是我查阅了一些资料，并整理如下。</p>
      ...
      <p>二、饮茶可强身健体</p>
      <p><img src="${health3}" align="left" width="30%" hspace="15" vspace="5" />1. 喝茶可保护心脏</p>
      ...
      <p><img src=${health4} width="40%" align="right" width="30%" hspace="15" vspace="5" />8. 饮茶防治动脉粥样硬化</p>
      ...
      <p style="text-align:center"><img src=${health} width="40%"/></p>`,
  },
};
