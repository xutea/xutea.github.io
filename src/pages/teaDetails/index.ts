...
export const dataList = {
  '白茶': {
    ...
    text: `<p>中国茶类的划分有多种方法，根据制作方法和茶多酚氧化（发酵）程度的不同，可分为六大类(茶叶中发酵程度的轻重不是绝对的，当有小幅度的误差)：绿茶（不发酵）、白茶（轻微发酵）、黄茶（轻发酵）、青茶（乌龙茶、半发酵）、黑茶（后发酵）、红茶（全发酵）。外观由绿向黄绿、黄、青褐、黑色渐变，茶汤也由绿向黄绿、黄、青褐、红褐色渐变。今天我们首先来介绍白茶。</p>
      <p>一、白茶的文献记载</p>
      <p><img src="${white4}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>白茶的名字最早出现在唐朝陆羽的《茶经》七之事中，其记载：“永嘉县东三百里有白茶山。”陈橼教授在《茶叶通史》中指出：“永嘉东三百里是海，是南三百里之误，南三百里是福建福鼎（唐为长溪县轄区），系白茶原产地。”可见唐代长溪县，也就是现在福建福鼎已培育出“白茶”品种，因成品茶多为芽头，满披白毫，如银似雪而得名。</p>
      <p>
      ...
      <p>二、白茶的传说</p>
      <p> <img src="${white1}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"></p>
      ...
      <p > <img src="${white3}" align="right" width="40%" hspace="15" vspace="5" width="50%" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"></p>
      ...
      <p > <img src="${white6}"  align="left" width="40%" hspace="15" vspace="5" width="50%" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"></p>
      ...
      <p><img src="${white5}" width="25%" align="right" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
  ...
  '绿茶': {
    ...
    text: `<p>一、绿茶的历史</p>
      ...
      <p > <img  align="left" src="${green1}" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"></p>
      ...
      <p>1.第一步，鲜叶採摘</p>
      <p><img src="${green4}"  align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>绿茶的採摘突出一个早和嫩。</p>
      ...
      <p>炒青绿茶分为锅式杀青和滚筒杀青。</p>
      <p ><img src="${green2}" width="40%" align="left" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
      ...
      <p ><img src="${green6}" width="40%" align="right" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
      ...
      <p>四、绿茶的功效和药用价值</p>
      <p><img src="${green5}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>绿茶性质寒凉，伤胃、泻火，如果喝新的绿茶，火在上，寒在下，喝了会胃不舒服，且容易上火。虚寒体质的人不建议喝绿茶，如果想喝的话，可以适当的放一点盛放一年以上的老绿茶。</p>
      <p>绿茶要考虑地域和人体差异。</p>
      ...
      <p>五、绿茶的储存</p>
      <p>首先，还是要避光、干燥。</p>
      <p ><img src="${green3}" width="40%" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
  ...
  '红茶': {
    ...
    text: `
      ...
      <p><img align="right" width="40%" hspace="15" vspace="5" src="${red1}" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>待到第二天军队离去，茶农才返回茶场，而前一天采好的茶青因无法得到及时处理，已经产生红变，为了挽回损失，茶农迅速将这些茶叶搓揉，并用当地易燃的马尾松木加温烘干。</p >
      <p>
      ...
      <p><img src="${red2}"  align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>第一步，鲜叶采摘。</p >
      <p>
      ...
      <h3>三、红茶的分类</h3>
      <p>1.小种红茶</p >
      <p><img src="${red3}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>小种红茶是福建特有的一种条形红茶，分正山小种和外山小种，它们之间的区别在于产地、制作工艺和风味特点。</p >
      ...
      <p>2.工夫红茶</p >
      <p><img src="${red6}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
      ...
      <p>3.红碎茶</p >
      <p><img src="${red4}"  align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>红碎茶的茶青在初制时经过充分的揉切，细胞破坏率高，有利于多酚类酶促氧化，形成了香气高锐持久、滋味浓强鲜爽。加糖或牛奶后仍有较强茶味的品质特徵。</p>
      ...
      <p><img src="${red5}" width="40%" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
  ...
  '黑茶': {
    ...
    <h2><img src="${black3}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>一、黑茶的起源</h2>
    ...
    <img src="${black7}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    ...
    <p><img src="${black2}" width="40%" align="right" hspace="15" vspace="5" style="margin-left:20px;" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    ...
    <p>一级毛茶主制天尖和贡尖；</p>
    <p>二级毛茶主制贡尖和生尖；</p>
    <img  src="${black1}" width="40%" align="left" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    ...
    <h3>3.广西六堡茶
    <img src="${black4}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    </h3>
    ...
    <img src="${black5}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    <p>篓装茶外形为圆柱形。</p >
    ...
    <p ><img src="${black6}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    <h3>5.云南普洱茶</h3>
    ...
    <h3>5.干燥</h3>
    <img src="${black9}" width="40%" align="left"  hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    ...
    <p><img src="${black8}" width="40%" align="right"  hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    <p>参考文献：</p>
  ...
  '青茶': {
    ...
    text: `<p>青茶俗称乌龙茶，属半发酵茶，是我国六大基本茶类中独具特色的一个茶类。</p>
      ...
      <p><img src="${qing3}"  width="40%" align="right" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    ...
    <p><img src="${qing1}" align="left" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>台湾乌龙是清朝初年由福建武夷山传入台湾，制法仿效武夷岩茶。</p>
    ...
    <img src="${qing2}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    ...
    <p><img src="${qing7}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    ...
    <p><img src="${qing4}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/></p>
    ...
    <img src="${qing5}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    ...
    <img src="${qing6}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
  ...
  "茶与神农（理工版）": {
    ...
    text: `
      ...
      <p><img src="${nong1}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />《史记·补三皇本纪》说，“神农氏作蜡祭，以赭鞭鞭草木，尝百草，始有医药。”《淮南子·修务训》说，“神农尝百草之滋味，一日而遇七十毒。”晋干宝《搜神记》说，“神农以赭鞭鞭百草，尽知其平毒寒温之性，臭味所主，以播百谷。”《述异记》说，“太原神釜冈中，有神农尝药之鼎存焉。咸阳山中，有神农鞭药处。”</p>
  ...
  "茶与神农（文史哲版）": {
    ...
    <h3><img src="${nong1}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>三、神农是谁</h3>
    ...
    <p ><img src="${nong2}" width="40%" align="left"  hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" /></p>
    ...
    <p ><img src="${nong3}" width="30%" align="right"  hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" /></p>
  ...
  "茗香飘万里 何须恋糖精": {
    ...
    <h3><img src="${huodong1}"  align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>一、活动背景</h3>
   ...
   <img src="${huodong2}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
    <h3>二、活动目的</h3>
    <p>为引导同学们建立健康的饮水习惯，同时传承中国茶文化，SDSZ茶文化研究社的同学们共同倡议开展“茗香飘万里，何须恋糖精”的活动。</p>
    <h3>三、活动过程</h3>
    <img src="${huodong3}" width="20%" align="right" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
  ...
  '茶与养生保健': {
    text: `
      ...
      <p><img src="${health2}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>昨天线下活动开展后，有同学问我，喝茶到底对身体有什么好处？这毕竟是个严肃的问题，回答的内容必须要有依据。于是我查阅了一些资料，并整理如下。</p>
      ...
      <p>二、饮茶可强身健体</p>
      <p><img src="${health3}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>1. 喝茶可保护心脏</p>
      ...
      <p>4. 饮茶可降胆固醇</p>
      <p><img src=${health4} width="40%" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>法国国立健康和医学研究所曾经进行临床试验，让 20 多名血脂含量高的病人每天喝一杯云南沱茶，两个月后，病人平均血脂含量下降 22%。我国昆明医学研究所也开展过类似研究，结论相似。</p>
      <p>5. 饮茶可增强人体免疫力</p>
      ...
      <img src=${health} width="30%" align="left" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;"/>
      <p>9. 饮茶防治肝病</p>
...
<img src="${huang1}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${huang2}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${huang4}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${huang5}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${huang3}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${huang6}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${puer1}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h3>一、按照产区、山头划分</h3>
...
<img src="${puer2}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h3>二、按照茶树品种划分</h3>
...
<p><span style="font-weight: bold;">熟茶：</span>熟茶是指经过特殊微生物发酵处理的普洱茶。熟茶的茶叶颜色较深，茶汤呈红褐色，口感醇厚，带有独特的陈香。</p> <h3>四、按照年份划分</h3>
    <img src="${puer3}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<p><span style="font-weight: bold;">新茶：</span>新茶是指当年鲜叶采摘制成的普洱茶。新茶具有鲜嫩的茶叶和清爽的口感，茶汤呈绿黄色。</p>
    ...
    <img src="${puer4}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <h3>六、根据茶叶的外形划分</h3>
...
<img src="${liubao3}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${liubao1}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
实验通过大鼠灌胃受试物水浸提物 35 天后采血测定总胆固醇和甘油三酯的含量、丙谷转氨酶和谷草转氨酶的活性，分别对比普洱茶(熟茶)茶粉、黑茶茶粉、六堡茶的功效。<img src="${liubao2}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" /> 实验果证明、这三类茶叶都具有促进脂肪消化的功能，能防止脂肪在血管内和肝脏中沉积，起到预防脂肪肝和动脉粥样硬化的作用，其中六堡茶的效果最好。</p>
...
`
  ...
  '六堡茶': {
    title: '六堡茶',
    text: `<p>六堡茶(LIU PAO TEA)是历史名茶,因原产于广西梧州市苍梧县六堡镇而得名。据《广西通志稿》记载“六堡茶在苍梧，茶叶出产之盛，以多贤乡之六堡及五堡为最，六堡尤为著名，畅销于穗、佛、港、澳等埠”。<img src="${liu1}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />六堡茶属我国六大茶类之一的黑茶，是一种后发酵茶，为广西梧州传统出口的土特产品。其品质优良，风味独特，外形条索长整紧结，色泽黑褐油润，间有黄花（又称发“金花”），汤色红浓明亮，滋味醇厚甘爽，香气陈纯，带有槟榔香（传统六堡茶还带有松烟味和槟榔香味特点），叶底铜褐色，耐于久藏越陈越好。六堡茶的品质特点是“红、浓、陈、醇”带槟榔香。</p>
    <p>制造六堡茶的原料，大部分采用当地大叶种、中小叶种茶树，采摘一芽二、三叶新梢，其制作分为初制：鲜叶稍经日晒——杀青——揉捻——渥堆——复揉——干燥成毛茶。再进行精制：分级——拼配——渥堆发酵——干燥——蒸压——晾置陈化——成品包装。</p>
    <img src="${liu2}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <img src="${liu4}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <img src="${liu3}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
  ...
  '细数那些曾经在东洋茶桌占领“C位”的六堡茶': {
    ...
    text: `<img src="${cbao1}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" /><p>六堡茶与日本的渊源不可谓不深，而中茶六堡的“旅日”经历，更是可以用奇妙来形容——由于经过一批日本黑茶专家的前期研究，发表过多篇学术论文，论述六堡茶的优异性，所以在八十年代初，最早一批“到达”日本的六堡茶，是摆在药店中出售的。</p>
    ...
    <p>在2006年以前，由于出口六堡茶需要凭外经贸部（商务部）颁发的“特种茶出口配额许可证”或广西外经委颁发的“红茶出口配额许可证”才能出口，<img src="${cbao2}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />1962年，梧州茶叶土产进出口支公司（现梧州中茶茶业有限公司）获得自营出口权，并通过梧州口岸独家经营以六堡茶为主的茶叶出口业务。一直到2006年取消茶叶的出口配额许可证管理，可以说中茶窖藏六堡茶基本承包了近半个世纪海内外茶客对六堡茶的味觉口感记忆。</p>
    ...
    <img src="${cbao3}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <img src="${cbao4}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    
    <p>专供日本出口的5101规格为25KG/箱，出口到日本后，大部分经过再包装后销往消费者手中，这就是后来风靡日本的六堡茶，开始谱写一段六堡茶名扬海外的佳话。</p>
    <br/>
    <p>【外贸5101】</p>
    <img src="${cbao5}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <br/>
    <p>【黑盒六堡茶】</p>
    <img src="${cbao6}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <p>第一代“黑盒六堡茶”在日本热销，也就是由“中国土产畜产进出口公司 广西壮族自治区分公司梧州支公司”生产的“黑茶六保茶”，被茶友们称为“无土黑盒”。日本人认为六堡茶具有较多的保健功效，特将“堡”改为“保”，这就是“无土黑盒”的由来。</p>
    <img src="${cbao7}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <p>早期生产的“无土黑盒”如今已一盒难求，身价上涨百倍。为了回顾历史，重现经典，让茶人能更好的感受外贸六堡茶的魅力，中茶公司复刻了十版黑盒六堡茶，每一次的上市都掀起狂潮。</p>
    <br/>
    <p>【中茶108】</p>
    
    <p>茶饮，一直被视为健康的天然饮品，因此在日本，喝茶被视为一种健康生活习惯。<img src="${cbao8}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />设计上，【中茶108】沿用了80年代日本纸媒的“老人安享茶乐”的经典广告画面，表达了健康的喝茶观念和“乐享茶趣”的饮茶理念，就如主画面上的长者，喝到好茶后的会心一笑，也是品饮茶叶的另一种真谛。</p>
    <p>茶起源于中国，盛行于世界，由来已历千年。<img src="${cbao9}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />这枚小小的“东方神叶”，在不同国度、不同文化的群体中广泛晕染，展现出人类对和平安宁的期盼，对美好生活的向往。“和而不同、美美与共”在经典的【黑盒】、【5101】、【中茶108】的悠悠茶韵中感受文明的互鉴和文化的流传，在复刻传承中品茗论道，以其不可替代的意义和价值奉献给各位。</p>
  ...
  '六堡茶韵绕京彩，三伏时节享清欢': {
    ...
    text: `
    <p>京彩瓷博物馆的馆长史琴，是我的茶友，也是我忘年交。在六大茶类中，史馆长偏好黑茶，其中以广西六堡为最爱。<img src="${dong31}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />今年夏天的一次茶会中，我采访了史馆长，听她讲述了她与广西六堡黑茶之间的不解之缘</p>
    ...
    <img src="${dong32}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <img src="${dong33}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <img src="${dong34}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    ...
    <img src="${dong35}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
  ...
  '小小的叶子 大大的健康': {
    title: '小小的叶子 大大的健康',
    text: `<p>茶，一片片绿叶，一年年发芽，却承载着几千年的文化底蕴，它不仅是饮品，更是滋养身心的良药。<img src="${ye1}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />六堡以其独特的工艺，更是茶中最耐得住寂寞，最坚守健康屏障的保护伞。</p>
    <p>喝六堡五年，三伏天打卡六堡茶三年，五年来我用自己的体验和中茶的品质带动了身边的人和我一起品饮六堡。从最开始的自己，到一两个人，到现在的一群人；从我听讲学习去传达到我言传身教到现在我们一起交流，六堡使我收获了很多。“结庐在人境，而无车马喧。问君何能尔，心远地自偏。” 陶渊明笔下的茶香袅袅，心静如水是当下快节奏生活多么宝贵的心境，通过茶我体会到了。“喝茶当于瓦屋纸窗下，清泉绿茶，用素雅的陶瓷茶具，同二三人共饮，得半日之闲，可抵十年的尘梦。<img src="${ye2}" align="left" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />”周作人笔下可抵十年尘梦的半日之闲，通过茶我受益了。“一饮涤昏寐，情思爽朗满天地；再饮清我神，忽如飞雨洒轻尘；三饮便得道，何须苦心破烦恼。”皎然用他的生活经历与茶的淡淡的苦涩和回甘相结合，告诉了我们喝茶的美妙感受我契合了。</p>
    <p>如果说通过茶，我们在岁月的长河中与古人同频同感，那么近三年，每年打卡六堡茶的日趋完善，我们在专业的茶人、专家团队的保驾护航中，健康的饮茶，饮健康的茶。</p>
    <img src="${ye3}" align="right" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <p>我们知道了茶叶中所含的咖啡因，可以提神醒脑；茶多酚及其他功能性成分能抑制脂肪吸收，促进新陈代谢；抗氧化剂能中和自由基，保护细胞免受损伤；茶多芬抗菌，抗炎，抗衰老，预防肿瘤等慢性病等。我们也了解了，与那些很少喝茶的人相比，经常喝茶的人患致命心脏病或中风的风险要低22%，过早死亡风险要低15%。对于长期保持饮茶习惯的人来说，这些数字分别上升到了56%和29%。习惯性饮茶的50岁人群（每周至少饮茶三次）患冠心病或中风的年龄比那些很少或从不喝茶的人晚1.41年，寿命长1.26年。 我们在交流中，用这些准确的专业术语代替以往的“也许是”“我觉得”，用精准的数据解读六堡茶的九大功效，让更多人放下了怀疑和犹豫，坚定地和我们共饮共情。<img src="${ye4}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />暑期出行六人，五人带茶，三人带六堡茶，最后六人每晚都喝闷泡的六堡茶，十一天坚持下来，无一人上火便秘，发烧感冒。出行结束后，我每天增至20克投茶量，不知不觉中，体重减轻四斤，上厕所轻松了。上厕所轻松是我喝六堡茶的初衷，前两年打卡，我都有记录，但收效甚微，今年6月4日，秋玲发圈祛湿提示，告知坚持21天会有惊喜，果然不负我们。其实喝茶健康大家都很清楚，而喝六堡茶只能是更健康，我们在专家团队的指导下科学饮茶，喝有千年传承的茶，喝有科研、品控把关的安全之茶。而喝茶又能洗去尘世的浮躁，留下清香淡雅，让人心静如水，从容开朗。</p>
  ...
  '奶茶的潜在健康风险': {
    title: '奶茶的潜在健康风险',
    text: `<p>在当今快节奏的生活中，奶茶作为一种时尚饮品，已经成为许多年轻人的“必需品”。然而，在享受其美味的同时，健康专家警告，奶茶潜藏的健康隐患不容小觑。<img src="${naicha1}" align="right" width="22%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />本文将深入探讨奶茶的坏处，从多个角度分析其对身体健康的潜在影响。</p>
    <h3>一、奶茶的成分及其影响</h3>
...
<img src="${naicha2}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<h4>2.2 牙周病的潜在风险</h4>
<img src="${naicha3}" align="right" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<h4>3.2 对消化系统的影响</h4>
<img src="${naicha4}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${naicha5}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>4.2 依赖性的问题</h4>
...
<img src="${naicha6}" align="left" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>5.2 提升消费者意识</h4>
...
<img src="${naicha7}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <h3>一、奶茶的流行与成分分析</h3>
...
<img src="${naicha8}" align="right" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>1.2 饮品成分的多样性</h4>
...
<h4>2.1 高糖饮食与慢性病</h4>
<img src="${naicha9}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<h4>3.1 龋齿的加剧</h4>
<img src="${naicha10}" align="right" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<img src="${naicha11}" align="left" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>4.2 对消化的影响</h4>
...
<h4>5.1 加强市场监管</h4>
<img src="${naicha12}" align="right" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
...
<p>奶茶的流行带来了便利与享受，但其潜在的健康隐患不容忽视。面对健康问题，消费者需保持警觉，做到理性消费和适量饮用，以实现真正的健康生活。在享受生活的同时，关注身体与心理健康，才是现代生活的智慧选择。</p>`
  ...
  '普洱茶的魅力与健康益处': {
    ...
    <img src="${puer5}" align="left" width="40%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <h3>一、普洱茶的起源与历史</h3>
...
<img src="${puer6}" align="right" width="30%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h3>二、普洱茶的健康益处</h3>
...
<img src="${puer7}" align="left" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>2.3 促进新陈代谢</h4>
...
<img src="${puer8}" align="right" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h3>三、普洱茶的饮用方法</h3>
<h4>3.1 正确的泡茶技巧</h4>
...
<img src="${puer9}" align="left" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h3>四、普洱茶的储存与保养</h3>
...
<p>普洱茶作为一种独特的茶饮，其丰富的历史和文化背景，加上多种健康益处，使其成为茶友们心中的“佳品”。无论是日常饮用，还是作为养生保健的饮品，普洱茶都能为人们的健康生活增添一份色彩。</p>`
  ...
  '红茶的魅力与健康益处': {
    ...
    <img src="${red7}" align="left" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
    <h3>一、红茶的起源与历史</h3>
...
<img src="${red12}" align="right" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>1.2 文化背景</h4>
...
<img src="${red10}" align="left" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>2.2 增强免疫力</h4>
...
<img src="${red9}" align="right" width="35%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
<h4>2.5 促进新陈代谢</h4>
...
<h4>3.2 饮用时间</h4>
<img src="${red11}" align="left" width="25%" hspace="15" vspace="5" style="box-shadow: 0px 0.208333vw 0.833333vw rgba(0, 0, 0, 0.25); border-radius:12px;" />
